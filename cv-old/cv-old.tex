...
\descript{BEng in Computer Engineering}
...
\location{November 2016 – Current | Sydney, QLD}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
\location{November 2015 – Current | Toowoomba, QLD}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
\descript{| Electrical Engineering Officer Trainee}
